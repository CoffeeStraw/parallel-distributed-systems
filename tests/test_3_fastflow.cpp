/**
 * Test the FastFlow version of the Huffman encoding algorithm,
            ...
            {
                {
                    ...
                    string binaryString = huffman_encode::fromStringToBinaryFastFlow(text, huffmanMap, nWorkers);

                    // STEP 6: Convert the binary string to an ASCII string
                    huffman_encode::padString(binaryString);
                    string asciiString = huffman_encode::fromBinaryToASCIIFastFlow(binaryString, nWorkers);
